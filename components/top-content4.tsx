...
import SkinClinicLogo6 from "./skin-clinic-logo4";
import styles from "./top-content4.module.css";

export type TopContent6Type = {
  className?: string;
  color?: CSSProperties["color"];
};

const TopContent6: NextPage<TopContent6Type> = ({ className = "", color }) => {
  return (
