...
import styles from "./instagram-section4.module.css";

export type InstagramSection6Type = {
  className?: string;
};

const InstagramSection6: NextPage<InstagramSection6Type> = ({
  className = "",
}) => {
  return (
...
export default InstagramSection6;
