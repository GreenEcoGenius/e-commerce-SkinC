...
import styles from "./instagram-section1.module.css";

export type InstagramSection1Type = {
  className?: string;
};

const InstagramSection1: NextPage<InstagramSection1Type> = ({
  className = "",
}) => {
  return (
...
export default InstagramSection1;
