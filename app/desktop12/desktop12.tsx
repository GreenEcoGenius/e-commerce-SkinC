...
import InstagramSection4 from "../../components/instagram-section3";
import ImageWrapper4 from "../../components/image-wrapper3";
import Footer5 from "../../components/footer31";
import SkinClinicLogo5 from "../../components/skin-clinic-logo31";
import GlobalNavigationDesktop5 from "../../components/global-navigation-desktop31";
import styles from "./desktop12.module.css";

const Desktop12: NextPage = () => {
  return (
